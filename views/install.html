...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <section>
        <div class="nes-container  with-title">
          <h2 class="title">Sign up for Boosted Apps(OPTIONAL)</h2>
          <div class="message-list">
            <div class="message -left">
              <i class="nes-bcrikko"></i>
              <!-- Balloon -->
              <div class="nes-balloon from-left">What are Boosted Apps?</div>
            </div>

            <div class="message -right">
              <!-- Balloon -->
              <div class="nes-balloon from-right">
                Boosted apps are Glitch apps that are powered up so they don't
                go to sleep. They are a benefit for paid Glitch subscribers.
              </div>
              <i class="nes-bcrikko"></i>
            </div>
          </div>
          ...
          <span>
            <a
              href="https://glitch.com/pricing?utm_medium=weblink&utm_source=discord%20starter&utm_campaign=none"
              target="pro"
              class="nes-btn is-primary"
            >
              <i class="nes-icon star"></i> Unlock Boosted Apps
    ...
    <footer>Made with <a href="https://glitch.com">Glitch</a>! <a href="https://github.com/glitchdotcom/starter-discord">Feedback? Bugs? Open an issue or PR on GitHub.</a></footer>
